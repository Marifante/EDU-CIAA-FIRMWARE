...
/*
 * @brief Configs a DMA channel
 * @param src: memory address of the source
 * @param dst: memory address of the destination
 * @param lli: memory addres of the first lli of the transfer
 * @param ctrl_wrd: control word for the channel
 * @param cfg_wrd: config word for the channel
 * */
void Chip_GPDMA_InitChannelCfg(uint8_t ChannelNum,				/*	Channel number, must be from 0 to 7	*/
